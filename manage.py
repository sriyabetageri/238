# this code is to script for managing a Flask application. 
# Used to manage the Flask application's database, including resetting and seeding it with sample data. 
# It serves as a convenient tool during development and testing phases.
