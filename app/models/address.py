#model with columns representing address attributes, including a foreign key relationship with the "users" table. 
# It provides methods for creating and updating address records in the database
